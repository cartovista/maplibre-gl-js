...
import fillBlendFrag from './fill.blend.fragment.glsl.g';
...
import fillBlendVert from './fill.blend.vertex.glsl.g';
...
export const shaders = {
    ...
    fillGradient: compile(fillGradientFrag, fillGradientVert),
    fillBlend: compile(fillBlendFrag, fillBlendVert),
